...
vip(fit, num_features = 40) + ggtitle("Variable importance")
ranger_select <- vip(fit, num_features = 40)
...
# Visualization of the most important features.
vip(glmnet_fit, num_features = 40) + ggtitle("Variable importance")
glmnet_select <- vip(fit, num_features = 40)
...
# Visualization of the most important features.
vip(ranger_fit, num_features = 40) + ggtitle("Variable importance")
...
# Visualization of the most important features.
vip(xgbtree_fit, num_features = 40) + ggtitle("Variable importance")
